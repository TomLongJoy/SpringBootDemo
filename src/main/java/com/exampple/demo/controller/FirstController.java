...
public class FirstController {
	...
	JObject helloworld(@RequestParam(value = "userName") String userName,@RequestParam(value = "password") String password){
...
//		System.out.println("@ComponentScan(basePackages = {\"com.example.demo\",\"com.exampple.demo.controller\"})");
		...
		return new JObject(userName,password);//"Hello " + userName;
